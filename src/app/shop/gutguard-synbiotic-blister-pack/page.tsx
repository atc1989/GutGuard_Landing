      ...
      <main className="min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:px-10 lg:px-12">
          ...
          <nav aria-label="Breadcrumb" className="mb-8 flex flex-wrap items-center gap-2 text-[0.85rem] text-slate-500">
            ...
            <span>/</span>
            <span className="text-slate-800">GutGuard SynBiotic+ Blister Pack</span>
          </nav>
            ...
            <div>
              <div className="overflow-hidden bg-[#E8E9EB]">
                <Image
                  ...
                  height={717}
                  priority
                  src="https://gutguard.ph/wp-content/uploads/2025/06/synbiotic-blister-600x717.png"
                  width={600}
                />
              </div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-8 space-y-2 border-t border-slate-100 pt-6 text-[0.88rem]">
                <p className="text-slate-500">
                  <span className="font-medium text-slate-700">SKU: </span>1-1
                </p>
                <p className="text-slate-500">
                ...
                <p className="text-slate-500">
                  <span className="font-medium text-slate-700">Product ID: </span>5565
                </p>
              </div>
            </div>
          </div>
            ...
            <ul className="mt-8 grid w-fit grid-cols-1 gap-6 sm:grid-cols-2">
              <li>
                <div className="group flex w-[220px] flex-col">
                  <Link href="/shop/gutguard-synbiotic">
                  ...
                  <div className="mt-3 space-y-1 px-1">
                    <h3 className="text-[0.95rem] font-medium leading-snug text-slate-900">
                      <Link className="hover:text-[#1A26C8]" href="/shop/gutguard-synbiotic">
                        GutGuard SynBiotic+
                      </Link>
                    </h3>
                    <p className="text-[0.95rem] font-semibold text-slate-800">₱3,800.00</p>
                  </div>
