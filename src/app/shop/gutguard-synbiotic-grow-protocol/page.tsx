...
const galleryImages = [
  {
    ...
    thumb: "/images/products/grow-protocol-1.jpeg",
    alt: "GutGuard SynBiotic+ Grow Protocol Triple Biotic",
    width: 1200,
    height: 1200,
  },
  {
    src: "/images/products/grow-protocol-2.jpeg",
    thumb: "/images/products/grow-protocol-2.jpeg",
    alt: "GutGuard SynBiotic+ Grow Protocol Triple Biotic - Image 2",
    width: 1200,
    height: 1200,
  },
  {
    src: "/images/products/grow-protocol-3.jpeg",
    thumb: "/images/products/grow-protocol-3.jpeg",
    alt: "GutGuard SynBiotic+ Grow Protocol Triple Biotic - Image 3",
    width: 1200,
    height: 1200,
  },
  {
    src: "/images/products/grow-protocol-4.jpeg",
    thumb: "/images/products/grow-protocol-4.jpeg",
    alt: "GutGuard SynBiotic+ Grow Protocol Triple Biotic - Image 4",
    width: 1200,
    height: 1200,
  },
  {
    src: "/images/products/grow-protocol-5.jpeg",
    thumb: "/images/products/grow-protocol-5.jpeg",
    alt: "GutGuard SynBiotic+ Grow Protocol Triple Biotic - Image 5",
    width: 1200,
    height: 1200,
  },
  {
    src: "/images/products/grow-protocol-6.jpeg",
    thumb: "/images/products/grow-protocol-6.jpeg",
    alt: "GutGuard SynBiotic+ Grow Protocol Triple Biotic - Image 6",
    width: 1200,
    height: 1200,
  },
  {
    src: "/images/products/grow-protocol-7.jpeg",
    thumb: "/images/products/grow-protocol-7.jpeg",
    alt: "GutGuard SynBiotic+ Grow Protocol Triple Biotic - Image 7",
    width: 1200,
    height: 1200,
  },
];
...
const productTitle =
  "GutGuard SynBiotic+ Grow Protocol Triple Biotic (Pre + Pro + Post) 80 Billion CFU Probiotics for Women & Men | Supplement for Digestion, Energy, Cellular Support, Gut Health for Bloating Relief, Detox & Immunity";
...
export default function GutGuardGrowProtocolPage() {
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                ...
                <BuyNowButton productSlug="gutguard-synbiotic-grow-protocol" quantity={quantity} />
              </div>

              <div className="mt-8 space-y-2 border-t border-slate-100 pt-6 text-[0.88rem]">
                <p className="text-slate-500"><span className="font-medium text-slate-700">SKU: </span>1-3</p>
                ...
                <p className="text-slate-500"><span className="font-medium text-slate-700">Product ID: </span>1735690692352444128</p>
              </div>
            </div>
          </div>
