...
export default function HeroSection() {
  ...
  return (
    <section
      className="relative overflow-hidden bg-[linear-gradient(180deg,#071B54_0%,#0A2163_46%,#16358C_100%)] py-16 text-white sm:py-20 lg:py-24"
      id="top"
    >
      ...
      <Container className="relative" size="xl">
        <div className="relative mx-auto flex min-h-[640px] max-w-[1200px] flex-col items-center text-center sm:min-h-[700px] lg:min-h-[780px]">
          ...
          <div className="relative flex w-full flex-1 items-center justify-center">
            <div className="pointer-events-none absolute bottom-[-2.5rem] left-1/2 z-0 w-screen -translate-x-1/2 overflow-hidden">
              <div className="hero-marquee-track flex w-max whitespace-nowrap">
                <span className="mr-16 text-[160px] font-semibold leading-none text-white/8 sm:text-[190px] lg:text-[220px]">
                  {hero.decorativeText}
                </span>
                <span className="mr-16 text-[160px] font-semibold leading-none text-white/8 sm:text-[190px] lg:text-[220px]">
                  {hero.decorativeText}
            ...
            <Reveal className="relative z-20 mt-6 sm:mt-8 lg:mt-10 lg:-translate-y-2" delay={300} variant="scale">
              <Image
                alt={hero.heroImages.bottle.alt}
                className="floating-bottle relative z-10 h-auto w-[180px] drop-shadow-[0_24px_42px_rgba(1,8,27,0.44)] sm:w-[206px] lg:w-[228px]"
                height={540}
                priority
